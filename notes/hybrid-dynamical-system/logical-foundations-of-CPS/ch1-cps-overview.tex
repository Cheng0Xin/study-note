...
\textbf{Cyber-Physical System (CPS):} the systems combine \ctextbf{cyber capabilities} 
with \ctextbf{physical capabilities} to solve problems that 
...
systems that \ctextit{combine discrete dynamics with continuous dynamics}.
Their behavior includes both  
\vspace{-.5cm}
\begin{itemize}
  \item aspects that \ctextit{change discretely one step at a time}, and
  \item aspects that \ctextit{change continuously as continuous functions over time}.
\end{itemize}
